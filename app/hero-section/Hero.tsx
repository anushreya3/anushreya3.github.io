  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1N4XwyB3vEyAYQ0c0LvWvDaYOyDLFyFbk/view?usp=share_link"
            target="_blank"
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
            href="https://github.com/anushreya3"
            target="_blank"
          ...
          <Link
            href="https://www.linkedin.com/in/anushreya-sinha-6200a2222/"
            target="_blank"
      ...
      >
        ...
        >
          ...
          Logical, creative, highly-motivated engineering student dedicated to implement cutting edge technologies.
            {/* <Link
